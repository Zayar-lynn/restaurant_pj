	 ...
	 <!-- Indicators -->
	  ...
	  <div class="carousel-inner">
	    <div class="carousel-item active">
	      <img src="images/slide1.jpg" class="apple" alt="Los Angeles">
	    </div>
	    <div class="carousel-item">
	      <img src="images/slide2.jpg" class="apple" alt="Chicago">
	    </div>
	    <div class="carousel-item">
	      <img src="images/slide3.jpg"  class="apple" alt="New York">
	    </div>
	  </div>
